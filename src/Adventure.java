			...
			//player enters the cave
	         ...
	         if(playerChoice == 1){
	        	 ...
	        	 if(hasSword){
	        		 ...
	        		 hasMagicKey = true;
	        		 if(hasMagicKey == true){
	        			System.out.println("There is a treasure key inside the belly of the dragon, and there is a treasure chest inside the cave too!");
	        			Random generator = new Random();
	        			int gold;
	        			gold = generator.nextInt(11);
	        	 ...
	        	 //The player flees
	        	 System.out.println("As you run away to hide in the safety of your warm bed, the dragon yawn and returns to its slumber.");
	         }
		} else {
			//player runs away
